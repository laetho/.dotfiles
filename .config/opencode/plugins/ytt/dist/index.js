...
function isPrivateIP(ip) {
    ...
    return (ipv6Lower.startsWith("fc") || // ULA: fc00::/7
...
const YoutubeTranscriptPlugin = async (ctx) => {
    return {
        tool: {
            ytt: tool({
                ...
                async execute(args, context) {
                    ...
                    try {
                        ...
                        const tempDir = fs.mkdtempSync(path.join("/tmp", "ytt-" + randomSuffix + "-"));
                        try {
                            ...
                            if (!normalizedFilePath.startsWith(normalizedTempDir + path.sep) &&
